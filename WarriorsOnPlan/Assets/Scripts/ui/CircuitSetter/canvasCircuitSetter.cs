...
public class canvasCircuitSetter : MonoBehaviour {
    ...
    public void Start() {
        ...
        wordNUMBER = gameManager.GM.book.strNumber;
    ...
    public void activateSetter(Thing source) {
        ...
        foreach (GameObject obj in arrButtonCircuitType) {
            obj.GetComponent<buttonCircuitType>().isInteractable = tempIsInteractableTotal;
        }
    ...
    public void reactivateButtonCircuitType() {
        foreach (GameObject obj in arrButtonCircuitType) {
            obj.GetComponent<buttonCircuitType>().isInteractable = true;
        }
    }
    ...
    public void activateBoxCircuitConcrete(int parCurCircuitTypeBeingChosen) {
        ...
        for (int i = 0; i < arrButtonCircuitType.Count(); i++) {
            if (i != curCircuitTypeBeingChosen) {
                arrButtonCircuitType[i].GetComponent<buttonCircuitType>().isInteractable = false;
            }
        }

        boxCircuitConcrete.GetComponent<uiMoreBoxCircuitConcrete>().activateBoxCircuitConcrete(parCurCircuitTypeBeingChosen);
    }
