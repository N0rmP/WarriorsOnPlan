...
public class damageInfo {
    ...
    public void SHOW(Vector3 parTargetPosition) {
        combatManager.CM.FC.callVFX(vfxHit, combatManager.CM.FC.getRetrieverParticleStop(), parTargetPosition + new Vector3(UnityEngine.Random.Range(-0.3f, 0.3f), 1f, UnityEngine.Random.Range(-0.3f, 0.3f)));
    }
}